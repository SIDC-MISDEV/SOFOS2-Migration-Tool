    ...
    public class RecomputeQuery
    {
        public static StringBuilder GetAllTransactions()
        {
            ...
            sQuery.Append(@"SELECT * 
                        ...
                        (
                        -- POS 
                        select h.reference, d.itemcode, d.uomCode, d.conversion, IF(h.transtype = 'CD',d.quantity,  d.quantity * -1) as 'quantity', d.cost, IF(h.transtype = 'CD',d.total,  d.total * -1) as 'total', 'Sales' as 'TransactionType', h.transDate
                        from sapt0 h 
                        ...
                        -- RC 
                        select h.reference, d.itemcode, d.uomCode, d.conversion, d.quantity * -1 as 'quantity', d.cost, d.total * -1 as 'total','Sales' as 'TransactionType', h.transDate
                        from sapr0 h 
                        ...
                        -- IA 
                        select h.reference, d.itemcode, d.uomCode, u.conversion, d.variance, d.price, d.total,'Adjustment' as 'TransactionType', h.transDate
                        from iia00 h 
                        ...
                        -- ISSUANCE 
                        select h.reference, d.itemcode, d.uomCode, d.conversion, d.quantity * -1 as 'quantity', d.price as 'cost', d.total * -1 as 'total','Issuance' as 'TransactionType', h.transDate
                        from iii00 h 
                        ...
                        -- RG 
                        select h.reference, d.itemcode, d.uomCode, d.conversion, IF(h.transtype = 'CD',d.quantity,  d.quantity * -1) as 'quantity', d.price as 'cost', IF(h.transtype = 'CD',d.total,  d.total * -1) as 'total','ReturnGoods' as 'TransactionType', h.transDate
                        from prg00 h 
                        ...
                        -- RR 
                        select h.reference, d.itemcode, d.uomCode, d.conversion, d.quantity, d.price as 'cost', d.total,'Receiving' as 'TransactionType', h.transDate
                        from iir00 h 
                        ...
                        -- RV
                        select h.reference, d.itemcode, d.uomCode, d.conversion, d.quantity, d.price as 'cost', d.total,'ReceiveFromVendor' as 'TransactionType', h.transDate
                        from prv00 h 
